...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        //make the window movable when undecorated
    ...
    /**
     * Database actions to run when the program is first initialized
     * @throws Exception
     */
    @Override
    public void init() throws Exception {
        super.init();
        //is the database can't open then throw an error and close
